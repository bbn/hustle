...
module.exports = class ArtistView extends Backbone.View
  ...
  template: _.template('<div class="copy-block"><div class="artist-img"></div><label>WHO</label><div id="blurb"><%= blurb %></div><div id="url"><a href="<%= url %>" class="url" target="_blank">Visit Link</a></div></div><ul id="artist-events" class="listview"></ul>')
